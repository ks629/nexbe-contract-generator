  ...
  return (
    <Document>
      ...
      <Page size="A4" style={styles.page}>
        ...
        {/* Wykonawca */}
        <Text style={[styles.paragraphBold, { marginTop: 10 }]}>WYKONAWCA:</Text>
        <Text style={styles.paragraph}>
          ...
          reprezentowaną przez: {d.salesRep?.fullName || '_______________'} — {d.salesRep?.position || 'Przedstawiciel handlowy'},
          na podstawie pełnomocnictwa udzielonego przez Zarząd Spółki,
        ...
        {/* Zamawiający */}
        <Text style={[styles.paragraphBold]}>ZAMAWIAJĄCY:</Text>
        <Text style={styles.paragraph}>
      ...
      <Page size="A4" style={styles.page}>
        ...
        <Text style={styles.paragraph}>
          ...
          {d.pricing?.financing === 'OWN_FUNDS' ? 'ze środków własnych Zamawiającego.' : 'z innych źródeł finansowania (kredyt, leasing).'}
        </Text>
        ...
        <Text style={styles.paragraph}>
          2. Termin zakończenia prac montażowych: do 60 dni od daty zaksięgowania II transzy
          Wynagrodzenia na rachunku bankowym Wykonawcy oraz zaakceptowania Projektu
